...
def approve_leave(request_id: int, decided_by: int) -> dict:
    return _request("PATCH", f"/leave/{request_id}/approve", json={"decided_by": decided_by})


def reject_leave(request_id: int, decided_by: int) -> dict:
    return _request("PATCH", f"/leave/{request_id}/reject", json={"decided_by": decided_by})


def cancel_leave(request_id: int, decided_by: int) -> dict:
    return _request("PATCH", f"/leave/{request_id}/cancel", json={"decided_by": decided_by})
...
def delete_holiday(holiday_id: int, requested_by: int) -> None:
    return _request("DELETE", f"/holidays/{holiday_id}", params={"requested_by": requested_by})
